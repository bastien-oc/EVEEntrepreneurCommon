...
namespace EntrepreneurEsiApi.Models.Esi
{
    ...
    public class WalletJournalModelChar
    {
        ...
        /// </summary>
        [JsonIgnore][Column("wallet_owner_id")] public int WalletOwnerID;

        /// <summary>
        /// Internal Database use. Represents the name of the entity to whom the entry belongs.
        /// </summary>
        [JsonIgnore] [Column("wallet_owner_name")] public string WalletOwnerName { get; set; }

        /// <summary>
        /// Internal Database use. If corporate wallet, represents the ID of the wallet to which the entry belongs.
        /// </summary>
        [JsonIgnore] [Column("wallet_division")] public Int32 WalletDivision { get; set; }
    ...
    {
        [JsonIgnore] public static String Endpoint = "/corporations/{corporation_id}/wallets/{division}/journal/";

        /// <summary>
        /// Internal Database Use. Represents the Character or Corporation to whom the entry belongs.
        /// </summary>
        [JsonIgnore] [Column("wallet_owner_id")] public int WalletOwnerID { get; set; }
